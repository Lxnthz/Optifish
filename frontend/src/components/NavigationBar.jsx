    ...
    <nav className="hidden lg:block fixed top-0 w-full z-50">
      <div className="mx-13 my-5">
        <div
          ...
          <div
            className={`flex items-center gap-x-5 transition-all duration-300 ${
              isScrolled ? "text-[#04397B]" : "text-white"
            }`}>
            <Link to="/">
              <img
                className="transition-all duration-200 w-27 xl:w-32"
                src={isScrolled ? Logo : LogoWhite}
                alt="Optifish Logo"
              />
            </Link>
            <div
              className={`flex gap-x-1 transition-all duration-50 xl:text-lg ${
                isScrolled ? "text-[#04397B]" : "text-white"
              }`}>
              <Link
                to="/"
          ...
          <div
            className={`flex items-center gap-x-1 transition-all duration-50 xl:text-lg ${
              isScrolled ? "text-[#04397B]" : "text-white"
            }`}>
            <button
